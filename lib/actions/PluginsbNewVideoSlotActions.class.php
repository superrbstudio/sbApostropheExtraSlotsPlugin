...
/**
 * Description of PluginsbNewVideoSlotActions
 *
 * @author pureroon
 */
abstract class PluginsbNewVideoSlotActions extends aSlotActions
{
    public function executeEdit(sfRequest $request)
    {
        ...
        $this->form = new sbNewVideoSlotEditForm($this->id, array());
