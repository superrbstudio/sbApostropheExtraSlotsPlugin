...
/**
 * Description of PluginsbJQueryCountdownTimerSlotActions
 *
 * @author pureroon
 */
class PluginsbJQueryCountdownTimerSlotActions extends aSlotActions
{
  public function executeEdit(sfRequest $request)
  {
    ...
    $this->form = new sbJQueryCountdownTimerSlotEditForm($this->id, array());
